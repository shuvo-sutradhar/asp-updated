...
<html>
  <head>
    ...
    <style>
      ...
      /* 
        Set a max-width, 
        and make it display as block so it will automatically 
  ...
  <body>
    ...
    <header class="email-logo">
      <a href="{{ route('login') }}" class="logo float-left">
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="https://complianceprotectionpro.com/"> {{ $settings['title'] }} </a>.
                  </td>
                </tr>
              </table>
            </div>
