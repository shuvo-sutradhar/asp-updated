	...
	<div>
        ...
        <div class="main-content">
            <div class="pb-12 md:pb-0 flex justify-between items-center relative">
                ...
                <div class="flex">
                    <router-link :to="{ name: 'service.create'}" v-ripple class="text-sm rounded-lg shadow inline-flex items-center bg-indigo-500 cursor-pointer focus:outline-none focus:shadow-outline text-white py-2 px-4">
