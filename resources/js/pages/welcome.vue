      ...
      <div class="container max-w-6xl mx-auto h-full flex flex-col lg:flex-row justify-between items-center -mt-32 xl:px-0 px-8">
          <div class="flex flex-col items-center lg:items-start w-full max-w-xl lg:w-1/2 pt-48 lg:pt-20 xl:pt-40 text-center lg:text-left z-30">
            ...
            <div class="hidden sm:flex flex-col mt-12 lg:mt-24">
                ...
                <div class="flex">
                  <svg class="h-8 mr-4 fill-current text-gray-500 transition-color duration-150 hover:text-gray-600 cursor-pointer" viewBox="0 0 2499 1037" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg class="h-8 mr-4 fill-current text-gray-500 transition-color duration-150 hover:text-gray-600 cursor-pointer" viewBox="0 0 2350 2315" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg class="h-8 mr-4 fill-current text-gray-500 transition-color duration-150 hover:text-gray-600 cursor-pointer" viewBox="0 0 2500 2158" xmlns="http://www.w3.org/2000/svg">
                      <g stroke="none" stroke-width="1">
                  ...
                  <svg class="h-8 mr-4 fill-current text-gray-500 transition-color duration-150 hover:text-gray-600 cursor-pointer" viewBox="0 0 680 680" xmlns="http://www.w3.org/2000/svg">
                      <g stroke="none" stroke-width="1">
                  ...
                  <svg class="h-8 mr-4 fill-current text-gray-500 transition-color duration-150 hover:text-gray-600 cursor-pointer" viewBox="0 0 1681 417" xmlns="http://www.w3.org/2000/svg">
                      <g stroke="none" stroke-width="1">
                        <g>
            ...
            <svg class="absolute left-0 max-w-md -ml-64 mt-24 left-svg" viewBox="0 0 423 423" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
          ...
          <div class="flex flex-col lg:flex-row w-full mt-0 sm:mt-10 lg:mt-20">
            <div class="w-full max-w-md mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3 p-4">
                <div class="flex flex-col justify-center items-center w-full h-full mr-5 p-20 rounded-lg relative">
                  <svg class="w-full h-full absolute fill-current text-gray-100" viewBox="0 0 377 340" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                  ...
                  <!-- FEATURE Icon 1 -->
                  <svg class="w-20 h-20 relative" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <defs>
            ...
            <div class="w-full max-w-md mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3 p-4">
                <div class="flex flex-col justify-center items-center w-full h-full mr-5 p-20 rounded-lg relative">
                  <svg class="w-full h-full absolute fill-current text-gray-100" viewBox="0 0 358 372" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
            ...
            <div class="w-full max-w-md mx-auto mb-16 lg:mb-0 lg:w-1/3 p-4">
                <div class="flex flex-col justify-center items-center w-full h-full mr-5 p-20 rounded-lg relative">
                  <svg class="w-full h-full absolute fill-current text-gray-100" viewBox="0 0 378 410" xmlns="http://www.w3.org/2000/svg">
                      <g>
                        <g>
                  ...
                  <!-- FEATURE Icon 3 -->
                  <svg class="relative h-20 w-20" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <defs>
      ...
      <div class="mx-auto px-4 container overflow-hidden max-w-6xl flex flex-col lg:flex-row justify-between">
          <a href="/" class="block mr-4 w-1/3">
            <span class="flex items-center">
                <svg class="h-6 w-auto fill-current text-white" viewBox="0 0 281 280" height="280" xmlns="http://www.w3.org/2000/svg">
